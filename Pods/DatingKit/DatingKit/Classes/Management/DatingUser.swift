...
open class User {
    ...
    public func set(gender: Gender, completion: @escaping(_ operationStatus: ResultStatus) -> Void) {
        ...
        let task: UserTask = UserTask(route: "/users/set_gender",
                                      function: .setGender,
    ...
    public func set(lookingFor: LookingFor, completion: @escaping(_ operationStatus: ResultStatus) -> Void) {
        let task: UserTask = UserTask(route: "/users/set_looking_for",
    ...
    public func set(aim: Aim, completion: @escaping(_ operationStatus: ResultStatus) -> Void) {
        let task: UserTask = UserTask(route: "/users/set_aim",
                                      function: .setAim,
    ...
    public func set(chatType: ChatType, completion: @escaping(_ operationStatus: ResultStatus) -> Void) {
        let task: UserTask = UserTask(route: "/users/set_chat_type",
