...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DatingKit/DatingKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RevealingTableViewCell/RevealingTableViewCell.framework"
