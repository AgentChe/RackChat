...
public struct ConfigTrial {
    ...
    public init(trialInfo: TrialData, and price: String) {
        ...
        if trialInfo.title.contains("@price") {
            title = trialInfo.title.replacingOccurrences(of: "@price", with: price, options: .literal, range: nil)
        } else {
        ...
        reasons.append(Reason(title: trialInfo.firstTitle, subtitle: trialInfo.firstSubTitle, price: price))
        reasons.append(Reason(title: trialInfo.secondTitle, subtitle: trialInfo.secondSubTitle, price: price))
        reasons.append(Reason(title: trialInfo.tridTitle, subtitle: trialInfo.tridSubTitle, price: price))
...
public struct Reason {
    ...
    public init(title: String, subtitle: String, price: String) {
       if title.contains("@price") {
            self.title = title.replacingOccurrences(of: "@price", with: price, options: .literal, range: nil)
        } else {
            self.title = title
        }
        
        if subtitle.contains("@price") {
...
public struct CentralPriceTag {
   ...
   init(generalPaymenInfo: GeneralPayScreenData, and price: String) {
        ...
        if generalPaymenInfo.header.contains("@price") {
            headerString = generalPaymenInfo.header.replacingOccurrences(of: "@price", with: price, options: .literal, range: nil)
        } else {
            headerString = generalPaymenInfo.header
        }
        
        if generalPaymenInfo.name.contains("@price") {
            name = generalPaymenInfo.name.replacingOccurrences(of: "@price", with: price, options: .literal, range: nil)
        } else {
            name = generalPaymenInfo.name
        }
        
        if generalPaymenInfo.subname.contains("@price") {
            subname = generalPaymenInfo.subname.replacingOccurrences(of: "@price", with: price, options: .literal, range: nil)
        } else {
...
public struct SubPriceTag {
   ...
   public init(subPaymentInfo: SubPayScreenData, and price: String) {
        ...
        if subPaymentInfo.name.contains("@price") {
            name = subPaymentInfo.name.replacingOccurrences(of: "@price", with: price, options: .literal, range: nil)
        } else {
